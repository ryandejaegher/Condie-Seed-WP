...
<!--             <?php echo $fallRye_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'rye', 'treatment');
			?>
...
<!--             <?php echo $fallRye_inoculant ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'rye', 'innoculant');
			?>
...
<!--             <?php echo $fallRye_primer ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('primer', 'rye', 'primer');
			?>
