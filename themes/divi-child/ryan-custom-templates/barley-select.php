...
<!--             <?php echo $barley_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'barley', 'treatment');
			?>
...
<!--             <?php echo $barley_inoculant ?> -->

			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'barley', 'innoculant');
			?>
...
<!--             <?php echo $barley_primer ?> -->
						<?php 
			bbloomer_get_product_ids_by_tags('primer', 'barley', 'primer');
			?>
