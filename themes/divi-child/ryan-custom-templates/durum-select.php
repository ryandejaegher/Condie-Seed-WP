...
<!--             <?php echo $durum_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'durum', 'treatment');
			?>
...
<!--             <?php echo $durum_inoculant ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'durum', 'innoculant');
			?>
...
<!--             <?php echo $durum_primer ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('primer', 'durum', 'primer');
			?>
