...
<!--             <?php echo $canary_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'canary', 'treatment');
			?>
...
<!--             <?php echo $canary_inoculant ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'canary', 'innoculant');
			?>
    ...
    <div class="select-block">
        ...
        <div class="select-row">
<!--
             <?php echo $canary_primer ?>
-->
			<?php 
			bbloomer_get_product_ids_by_tags('primer', 'canary', 'primer');
			?>
