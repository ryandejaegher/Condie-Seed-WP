...
<!--             <?php echo $wheat_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'wheat', 'treatment');
			?>
...
<!--             <?php echo $wheat_inoculant ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'wheat', 'innoculant');
			?>
...
<!--             <?php echo $wheat_primer ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('primer', 'wheat', 'primer');
			?>
