...
<!--             <?php echo $flax_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'flax', 'treatment');
			?>
...
<!--             <?php echo $flax_inoculant ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'flax', 'innoculant');
			?>
...
<!--             <?php echo $flax_primer ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('primer', 'flax', 'primer');
			?>
