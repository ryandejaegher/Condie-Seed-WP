...
<!--             <?php echo $oat_treatment; ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('treatment', 'oat', 'treatment');
			?>
...
<!--             <?php echo $oat_inoculant ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('innoculant', 'oat', 'innoculant');
			?>
...
<!--             <?php echo $oat_primer ?> -->
			<?php 
			bbloomer_get_product_ids_by_tags('primer', 'oat', 'primer');
			?>
